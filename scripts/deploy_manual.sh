...
export MODEL_BUCKET_PROD="stg-mlflow-models-code-owners-mlops-xgoals"
export PREDICTIONS_STREAM_NAME="stg_shot_predictions-mlops-xgoals"
export LAMBDA_FUNCTION="stg_prediction_lambda_mlops-xgoals"
